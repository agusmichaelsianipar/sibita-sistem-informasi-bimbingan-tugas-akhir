<html>
    <head>
        <title>Ubah Dosen Pembimbing</title>
    ...
    <body>
        <div class="container">
            <br>
        <h2>Ubah Dosen Pembimbing</h2>
        <br> <br>
            <form method="post" action="/superadmin/aturdosbing/{{$dosen->id}}">
            {{ method_field('patch') }}
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" name="email" placeholder="Masukkan Email Dosen" value="{{ $dosen->email}}">
                    @if ($errors->has('email'))
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="password" name="password" value="{{ $dosen->password}}" placeholder="Masukkan Password Dosen">
                ...
                <div class="tombol">
                    <button type="submit" class="btn btn-outline-primary">Ubah Dosen</button>
                </div>                                
            </form>
        </div>
    </body>
