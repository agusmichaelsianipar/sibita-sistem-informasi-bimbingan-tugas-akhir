...
<div class="container">
        ...
        <br> <br>
            <form method="post" action="/superadmin/{{$mahasiswa->id}}/ubahmahasiswa/">
            {{ method_field('patch') }}
            {{ csrf_field() }}
                <div class="form-group">
                    <label for="nama">Nama Mahasiswa</label>
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Mahasiswa" value="{{ $mahasiswa->name }}">
                    @if ($errors->has('nama'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nim" name="nim" placeholder="Masukkan NIM Mahasiswa" value="{{ $mahasiswa->nim }}">
                    @if ($errors->has('nim'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" name="email" placeholder="Masukkan Email Mahasiswa" value="{{ $mahasiswa->email }}">
                    @if ($errors->has('email'))
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="password" name="password" placeholder="Masukkan Password Mahasiswa" value="{{ $mahasiswa->password }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="konfirmasi_password" name="konfirmasi_password" placeholder="Konfirmasi Password Mahasiswa" value="{{ $mahasiswa->password }}">
                    ...
                    <select id="semester" name="dosen_wali" height="100%">
                        <option value="{{ $mahasiswa->dosen_wali }}" selected>Pilih Dosen Wali</option>
                ...
                <div class="tombol">
                    <button type="submit" class="btn btn-outline-primary">Ubah Mahasiswa</button>
                </div>                                
            </form>
        </div>
@endsection